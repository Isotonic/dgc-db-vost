<template>
  <div class="col-xl-4 col-lg-6">
    <div :class="['card shadow', 'mb-4', deployment.open ? 'border-left-success' : 'border-left-closed']">
      ...
      <div class="card-body text-center">
        ...
        <router-link :to="{ name: 'incidents', params: { deploymentName: deployment.name.replace(/ /g, '-'), deploymentId: deployment.id }}" :class="['btn', deployment.open ? 'btn-success' : 'btn-closed']">View Deployment</router-link>
      </div>
    </div>
  </div>
</template>
